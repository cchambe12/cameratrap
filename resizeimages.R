### Resize code using Python - have not tried
## Found https://github.com/Evolving-AI-Lab/deep_learning_for_camera_trap_images/blob/master/resize.py
...
src_dir= "/project/EvolvingAI/mnorouzz/Serengiti/SER/S6/" ## source directory
dst_dir= "/gscratch/mnorouzz/S6/" ## destination
